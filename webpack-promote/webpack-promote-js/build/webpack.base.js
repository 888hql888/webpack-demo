...
module.exports = {
  ...
  plugins: [
    ...
    //优化 moment插件中的国际化语言，因为我们只使用中文，就可以把其它国际化语言给删除掉 大大减少moment包的体积.
    new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/),
    //指定已经打包好的 dll库文件，避免多次打包.
    new webpack.DllReferencePlugin({
      manifest: path.resolve(__dirname, '../dist/manifest.json')
    }),
    //添加dll库路径script标签到 index.html 上 （类似 htmlwebpackplugin） 注意这个插件要放在htmlwebpackplugin后面使用
